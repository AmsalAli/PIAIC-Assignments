...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.append(arr*1, arr, axis=None) #write your code here 
...
def function13():
    ...
    ans = arr[(arr > 5) ]#write your code here 
...
def function14():
    ...
    ans = np.array_split(arr, 8) #write your code here 
